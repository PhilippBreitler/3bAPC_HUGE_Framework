...
class RegistrationModel
{
    ...
    public static function registerNewUser()
    {
        ...
        if (!self::writeNewUserToDatabase($user_name, $user_password_hash, $user_email, time(), $user_activation_hash, 1)) {
     ...
     * @return bool
     */
    public static function writeNewUserToDatabase($user_name, $user_password_hash, $user_email, $user_creation_timestamp, $user_activation_hash, $user_active)
    {
        ...
        $query->execute(array(':user_name' => $user_name,
                              ...
                              ':user_active' => 1));    # User beim schreiben in die Datenbank schon Status aktiviert
